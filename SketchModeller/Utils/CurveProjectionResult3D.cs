...
namespace Utils
{
    ...
    /// </summary>
    public class CurveProjectionResult3D
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurveProjectionResult3D"/> class.
        /// </summary>
        ...
        public CurveProjectionResult3D(Point3D position, int segmentIndex, double distance)
        {
            Position = position;
        ...
        {
            var concrete = obj as CurveProjectionResult3D;
            if (concrete == null)
                return false;
            else
            {
